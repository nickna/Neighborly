...
/// <summary>
/// SIMD-optimized Euclidean distance calculator for 256-dimensional vectors.
/// </summary>
public sealed class SimdEuclideanDistance256Calculator : AbstractDistanceCalculator
{
    /// <summary>
    /// Static instance of the calculator.
    /// </summary>
    public static readonly SimdEuclideanDistance256Calculator Instance = new();

    private const int ExpectedDimension = 256;

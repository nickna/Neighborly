...
/// <summary>
/// SIMD-optimized Euclidean distance calculator for 512-dimensional vectors.
/// </summary>
public sealed class SimdEuclideanDistance512Calculator : AbstractDistanceCalculator
{
    /// <summary>
    /// Static instance of the calculator.
    /// </summary>
    public static readonly SimdEuclideanDistance512Calculator Instance = new();

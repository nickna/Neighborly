...
/// <summary>
/// SIMD-optimized Euclidean distance calculator for 1024-dimensional vectors.
/// </summary>
public sealed class SimdEuclideanDistance1024Calculator : AbstractDistanceCalculator
{
    /// <summary>
    /// Static instance of the calculator.
    /// </summary>
    public static readonly SimdEuclideanDistance1024Calculator Instance = new();

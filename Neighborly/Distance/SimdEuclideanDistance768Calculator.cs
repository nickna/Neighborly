...
/// <summary>
/// SIMD-optimized Euclidean distance calculator for 768-dimensional vectors.
/// </summary>
public sealed class SimdEuclideanDistance768Calculator : AbstractDistanceCalculator
{
    /// <summary>
    /// Static instance of the calculator.
    /// </summary>
    public static readonly SimdEuclideanDistance768Calculator Instance = new();

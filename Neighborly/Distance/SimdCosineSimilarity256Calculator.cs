...
/// <summary>
/// SIMD-optimized Cosine similarity calculator for 256-dimensional vectors.
/// </summary>
public sealed class SimdCosineSimilarity256Calculator : AbstractDistanceCalculator
{
    /// <summary>
    /// Static instance of the calculator.
    /// </summary>
    public static readonly SimdCosineSimilarity256Calculator Instance = new();
